          ...
          <div className="max-w-5xl mx-auto glass rounded-[2.5rem] p-4 shadow-2xl relative">
            ...
            <form onSubmit={handleSearch} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
              <div className="space-y-2 relative">
                <label className="text-xs font-bold text-gray-400 uppercase tracking-wider ml-1">Pickup</label>
                <div className="relative">
                  <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 text-primary w-5 h-5" />
                  <select
                    className="w-full pl-12 pr-4 py-3.5 bg-gray-50 border border-gray-100 rounded-xl focus:ring-2 focus:ring-primary focus:border-transparent transition-all outline-none font-bold text-sm text-gray-900 appearance-none cursor-pointer"
                    value={pickup}
              ...
              <div className="space-y-2 relative">
                <label className="text-xs font-bold text-gray-400 uppercase tracking-wider ml-1">Drop</label>
                <div className="relative">
              ...
              <div className="space-y-2 relative">
                ...
                <div className="relative">
                  ...
                  <input
                    type="date"
                    className="w-full pl-12 pr-4 py-3.5 bg-gray-50 border border-gray-100 rounded-xl focus:ring-2 focus:ring-primary focus:border-transparent transition-all outline-none font-bold text-sm text-gray-900"
                    value={date}
            ...
            <div className="flex flex-wrap gap-3">
              {rideFilters.map(filter => (
                <button
                  ...
                  className={`rounded-2xl border px-5 py-3 text-sm font-bold transition-all ${selectedRideClass === filter.id
